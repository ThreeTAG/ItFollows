...
public class IFItems {
    ...
    public static final RegistrySupplier<Item> OMINOUS_POT = ITEMS.register("ominous_pot", () -> new BlockItem(IFBlocks.OMINOUS_POT.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, ItFollows.id("ominous_pot")))));
    ...
    public static void addToTabs() {
        ...
        CreativeTabRegistry.modify(CreativeTabRegistry.defer(CreativeModeTabs.FUNCTIONAL_BLOCKS), (flags, output, canUseGameMasterBlocks) -> {
            output.acceptAfter(Items.DECORATED_POT, OMINOUS_POT.get());
        });
